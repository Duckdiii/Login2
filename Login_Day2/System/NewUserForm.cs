...
namespace Login_Day2
{
    public partial class NewUserForm : Form
    {
        ...
        private void Submit_btn_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("Insert into Log_in (Id, username, password, email, status) values(@id, @us, @pass, @email, @status)", myDB.getConnection);
            ...
            cmd.Parameters.Add("@status", SqlDbType.NChar).Value = "Pending";
